/* @ds-bundle: {"format":4,"namespace":"AvaloniaFluentDesignSystem_a08390","components":[{"name":"ICONS","sourcePath":"assets/icons/paths.js"},{"name":"Button","sourcePath":"components/core/Button.jsx"},{"name":"HyperlinkButton","sourcePath":"components/core/HyperlinkButton.jsx"},{"name":"PathIcon","sourcePath":"components/core/PathIcon.jsx"},{"name":"ToggleButton","sourcePath":"components/core/ToggleButton.jsx"},{"name":"Card","sourcePath":"components/data/Card.jsx"},{"name":"Expander","sourcePath":"components/data/Expander.jsx"},{"name":"ListItem","sourcePath":"components/data/ListItem.jsx"},{"name":"NotificationCard","sourcePath":"components/data/NotificationCard.jsx"},{"name":"ProgressBar","sourcePath":"components/data/ProgressBar.jsx"},{"name":"TabItem","sourcePath":"components/data/TabItem.jsx"},{"name":"TreeView","sourcePath":"components/data/TreeView.jsx"},{"name":"CheckBox","sourcePath":"components/forms/CheckBox.jsx"},{"name":"ComboBox","sourcePath":"components/forms/ComboBox.jsx"},{"name":"RadioButton","sourcePath":"components/forms/RadioButton.jsx"},{"name":"SearchBox","sourcePath":"components/forms/SearchBox.jsx"},{"name":"SegmentedControl","sourcePath":"components/forms/SegmentedControl.jsx"},{"name":"Slider","sourcePath":"components/forms/Slider.jsx"},{"name":"TextBox","sourcePath":"components/forms/TextBox.jsx"},{"name":"ToggleSwitch","sourcePath":"components/forms/ToggleSwitch.jsx"}],"sourceHashes":{"assets/icons/paths.js":"d3156795a7b0","components/core/Button.jsx":"7c3f7cc118dc","components/core/HyperlinkButton.jsx":"44944328aa7a","components/core/PathIcon.jsx":"f05292c1fbe9","components/core/ToggleButton.jsx":"a5e627aac6c1","components/data/Card.jsx":"2f106136c962","components/data/Expander.jsx":"b268e3353253","components/data/ListItem.jsx":"58f1a72082a6","components/data/NotificationCard.jsx":"dd2c84e5095a","components/data/ProgressBar.jsx":"5445723a0f42","components/data/TabItem.jsx":"954909eb73da","components/data/TreeView.jsx":"8013fb69c665","components/forms/CheckBox.jsx":"e59918a2a3f7","components/forms/ComboBox.jsx":"afe5441392fa","components/forms/RadioButton.jsx":"5d9ba445ca3c","components/forms/SearchBox.jsx":"f96a373849da","components/forms/SegmentedControl.jsx":"19b58869ac59","components/forms/Slider.jsx":"7d9d9f94fcc0","components/forms/TextBox.jsx":"29f378526403","components/forms/ToggleSwitch.jsx":"0df9daa66347","ui_kits/control_catalog/ButtonsScreen.jsx":"8adbfef8233f","ui_kits/control_catalog/CatalogShell.jsx":"e930fb06d8bd","ui_kits/control_catalog/FeedbackScreen.jsx":"e05aa6fa6157","ui_kits/control_catalog/FormsScreen.jsx":"8ffa70414dd4","ui_kits/pulse/PulseDetail.jsx":"ca73f3ac6772","ui_kits/pulse/PulseHome.jsx":"795968fd6835","ui_kits/pulse/PulseLogin.jsx":"d34251273ddd","ui_kits/pulse/PulseProfile.jsx":"c9a82bba4e98","ui_kits/pulse/PulseShell.jsx":"4f3eb2c33315"},"inlinedExternals":[],"unexposedExports":[]} */
...
const ICONS = {
  ...
  Speaker: "M14,3.23V5.29C16.89,6.15 19,8.83 19,12C19,15.17 16.89,17.84 14,18.7V20.77C18,19.86 21,16.28 21,12C21,7.72 18,4.14 14,3.23M16.5,12C16.5,10.23 15.5,8.71 14,7.97V16C15.5,15.29 16.5,13.76 16.5,12M3,9V15H7L12,20V4L7,9H3Z",
  Thermostat: "M15,13V5A3,3 0 0,0 12,2A3,3 0 0,0 9,5V13A5,5 0 1,0 15,13M12,4A1,1 0 0,1 13,5V8H11V5A1,1 0 0,1 12,4Z",
  VideoCamera: "M17,10.5V7A1,1 0 0,0 16,6H4A1,1 0 0,0 3,7V17A1,1 0 0,0 4,18H16A1,1 0 0,0 17,17V13.5L21,17.5V6.5L17,10.5Z",
...
function Node({
  ...
  const on = sel === path;
  const onClick = expandable ? () => setOpen(o => ({
    ...o,
    [path]: !(o[path] ?? node.defaultExpanded !== false)
  })) : () => pick(path);
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    role: "treeitem",
    "aria-expanded": expandable ? isOpen : undefined,
    "aria-selected": expandable ? undefined : on,
    onClick: onClick,
  ...
  }, expandable && /*#__PURE__*/React.createElement(Glyph, {
    open: isOpen
  ...
  }, node.name), expandable ? node.count != null && /*#__PURE__*/React.createElement("span", {
    style: {
      position: 'absolute',
      right: 10,
      top: '50%',
  ...
  }, node.count) : node.status && /*#__PURE__*/React.createElement("span", {
    style: {
      position: 'absolute',
      right: 10,
      top: '50%',
  ...
  })), expandable && isOpen && kids.map((child, i) => /*#__PURE__*/React.createElement(Node, {
    key: path + '/' + i,
    node: child,
    path: path + '/' + i,
    depth: depth + 1,
...
function TreeView({
  ...
  const pick = key => {
    onSelect ? onSelect(key) : setInternalSel(key);
  };
  return /*#__PURE__*/React.createElement("div", _extends({
    role: "tree",
    style: {
  ...
  }, rest), roots.map((node, i) => /*#__PURE__*/React.createElement(Node, {
    key: i,
    node: node,
    path: String(i),
    depth: 0,
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/data/TreeView.jsx", error: String((e && e.message) || e) }); }
...
function CheckBox({
  ...
  const fill = disabled ? on ? 'var(--surface-control-disabled)' : 'transparent' : on ? hover ? accentHover : accent : 'transparent';
  const stroke = disabled ? 'var(--border-disabled)' : on ? 'transparent' : hover ? pulse ? 'var(--pulse-text-3)' : 'var(--border-control-hover)' : pulse ? 'var(--pulse-text-4)' : 'var(--border-hairline)';
  ...
  return /*#__PURE__*/React.createElement("label", {
    ...
    style: {
      ...
      gap: 'var(--space-8)',
      fontFamily: 'var(--font-core)',
      fontSize: pulse ? 14 : 'var(--font-size-14)',
      color: disabled ? 'var(--text-disabled)' : pulse ? 'var(--pulse-text)' : 'var(--text-body)',
      ...style
    }
    ...
    style: {
      ...
      display: 'grid',
      placeItems: 'center',
      borderRadius: pulse ? 7 : 'var(--radius-control)',
      background: fill,
      border: (pulse ? '1.5px' : 'var(--border-width)') + ' solid ' + stroke,
      transition: 'var(--transition-control)'
    }
...
function ComboBox({
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    ...
    style: {
      ...
      justifyContent: 'space-between',
      gap: 'var(--space-8)',
      minHeight: pulse ? 48 : 'var(--control-height)',
      height: pulse ? 48 : 'var(--control-height)',
      boxSizing: 'border-box',
      padding: pulse ? '0 14px' : 'var(--padding-text-control)',
      borderRadius: pulse ? 12 : 'var(--radius-control)',
      ...
      fontFamily: 'inherit',
      fontSize: pulse ? 13 : 'var(--font-size-14)',
      textAlign: 'left',
      transition: 'var(--transition-control)'
    }
    ...
    style: {
      ...
      marginTop: pulse ? 6 : 2,
      padding: '4px 0',
      borderRadius: pulse ? 12 : 'var(--radius-overlay)',
      border: (pulse ? '1px' : 'var(--border-width)') + ' solid ' + (pulse ? 'var(--pulse-surface-2)' : 'var(--border-transient)'),
      background: pulse ? 'var(--pulse-surface)' : 'var(--surface-transient)',
      boxShadow: 'var(--shadow-flyout)'
    }
  }, items.map((it, i) => {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      onMouseEnter: e => {
        if (!selected) e.currentTarget.style.background = pulse ? 'var(--pulse-surface-2)' : 'var(--surface-list-hover)';
      },
      onMouseLeave: e => {
        if (!selected) e.currentTarget.style.background = 'transparent';
      },
      style: {
        padding: pulse ? '10px 14px' : 'var(--padding-combobox-item)',
        fontSize: pulse ? 13 : 'var(--font-size-14)',
...
function RadioButton({
  ...
  const accent = pulse ? 'var(--pulse-accent)' : 'var(--surface-accent)';
  const accentHover = pulse ? 'var(--pulse-accent-hover)' : 'var(--surface-accent-hover)';
  const stroke = disabled ? 'var(--border-disabled)' : checked ? hover ? accentHover : accent : hover ? pulse ? 'var(--pulse-text-3)' : 'var(--border-control-hover)' : pulse ? 'var(--pulse-text-4)' : 'var(--border-hairline)';
  const box = pulse ? 24 : 20;
  return /*#__PURE__*/React.createElement("label", {
    onMouseEnter: () => setHover(true),
    onMouseLeave: () => setHover(false),
...
function SearchBox({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      background: 'transparent',
      fontFamily: 'inherit',
      fontSize: 'var(--font-size-15, 15px)',
      color: 'var(--text-body)'
    }
  }, rest)));
}
...
function SegmentedControl({
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    ...
    return /*#__PURE__*/React.createElement("button", {
      key: item,
      type: "button",
      onClick: () => onChange && onChange(item, i),
      style: {
        border: 0,
        cursor: 'pointer',
        fontFamily: 'inherit',
...
function Slider({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: {
      ...
      backgroundSize: '100% ' + (pulse ? '4px' : 'var(--slider-track-height)'),
    ...
    style: {
      fontSize: pulse ? 13 : 'var(--font-size-12)',
      color: pulse ? 'var(--pulse-text-2)' : 'var(--text-secondary)',
      minWidth: 28,
      textAlign: 'right'
    }
  }, value), /*#__PURE__*/React.createElement("style", null, '.ds-slider-std::-webkit-slider-thumb{-webkit-appearance:none;width:16px;height:16px;border-radius:50%;background:var(--surface-accent);border:0}.ds-slider-std:hover::-webkit-slider-thumb{background:var(--surface-accent-hover)}.ds-slider-std:active::-webkit-slider-thumb{background:var(--surface-accent-pressed)}.ds-slider-std:disabled::-webkit-slider-thumb{background:var(--chrome-disabled-high)}.ds-slider-std::-moz-range-thumb{width:16px;height:16px;border:0;border-radius:50%;background:var(--surface-accent)}.ds-slider-pulse::-webkit-slider-thumb{-webkit-appearance:none;width:18px;height:18px;border-radius:50%;background:#fff;border:0;box-shadow:0 1px 3px rgba(0,0,0,.4)}.ds-slider-pulse:active::-webkit-slider-thumb{background:#fff}.ds-slider-pulse:disabled::-webkit-slider-thumb{background:var(--chrome-disabled-high)}.ds-slider-pulse::-moz-range-thumb{width:18px;height:18px;border:0;border-radius:50%;background:#fff}'));
}
...
function TextBox({
  ...
  const [hover, setHover] = React.useState(false);
  const [focus, setFocus] = React.useState(false);
  const border = disabled ? 'var(--border-disabled)' : error ? 'var(--text-error)' : focus ? pulse ? 'var(--pulse-accent)' : 'var(--border-focus)' : pulse ? 'var(--pulse-surface-2)' : 'var(--border-hairline)';
  const ring = error ? 'var(--text-error)' : 'var(--border-focus)';
  return /*#__PURE__*/React.createElement("label", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: pulse ? 8 : 'var(--space-4)',
      fontFamily: 'var(--font-core)',
      ...style
    }
  }, label && /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: pulse ? 12 : 'var(--font-size-12)',
    ...
    style: {
      ...
      background: pulse ? disabled ? 'var(--surface-control-disabled)' : 'var(--pulse-surface-2)' : disabled ? 'var(--surface-control-disabled)' : focus || hover ? 'var(--surface-control-hover)' : 'var(--alt-medium-high)',
      transition: 'var(--transition-control)'
    }
...
function ToggleSwitch({
  ...
  return /*#__PURE__*/React.createElement("label", {
    ...
    style: {
      ...
      background: disabled ? 'var(--surface-control-disabled)' : checked ? hover ? accentHover : accent : offTrack,
      border: (pulse ? '1px' : 'var(--border-width)') + ' solid ' + (disabled ? 'var(--border-disabled)' : checked ? 'transparent' : offBorder),
      transition: 'var(--transition-control)'
    }
  }, /*#__PURE__*/React.createElement("span", {
    style: {
